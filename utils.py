...
def save_checkpoint(save_path, dispnet_state, exp_pose_state,pixel_state, is_best, filename='checkpoint.pth.tar'):
    file_prefixes = ['dispnet', 'exp_pose','pixel']
    states = [dispnet_state, exp_pose_state,pixel_state]
